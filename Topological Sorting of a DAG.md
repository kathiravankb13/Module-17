...
## OUTPUT
![image](https://github.com/user-attachments/assets/d1634adb-caee-4133-bea1-4e3900e8c648)

## RESULT
Thus the Python program to **print topological sorting** of a **Directed Acyclic Graph (DAG)** is successfully verified.
